...
class Chart(Base):
    ...
    def parse(self, htmls):
        ...
        for item_row in self.trees[0].xpath("//tbody[@class='lister-list']/tr"):
            ...
            rating_text = item_row.xpath(".//td[contains(@class, 'imdbRating')]/strong/@title")
            if rating_text:
                print(rating_text[0])
            ...
            year = None
            for base_element in item_row.xpath(".//td[@class='titleColumn']//span[@class='secondaryInfo']/text()"):
